...
export function AiResumeBanner() {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 mb-6 rounded-lg border border-indigo-200 bg-indigo-50 shadow-sm animate-in fade-in slide-in-from-top-2 duration-300">
