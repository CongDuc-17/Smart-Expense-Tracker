...
export function SettingsPage() {
  ...
  if (error) {
    return (
      <div className="flex h-[80vh] items-center justify-center flex-col gap-2 text-foreground">
  ...
  return (
    <div className="max-w-4xl mx-auto w-full px-4 py-8 md:py-12">
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">Quản lý thông tin cá nhân và bảo mật của bạn.</p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6 items-start">
          ...
          <div className="hidden lg:block space-y-6">
            <div className="bg-card border border-border rounded-xl shadow-sm p-5">
              <h4 className="font-medium text-foreground mb-2">Bảo vệ tài khoản</h4>
